...
- Simplified the primary navigation to Home, Solutions, Work, Company and Start a Project. Industries and Insights remain available through the footer and internal links.
...
- Made production builds remove and recreate the output directory so deleted or renamed files cannot remain in a deployment.
...
- Lighthouse CI enforces a runner-safe Performance floor of 70, at least 90 for Accessibility, Best Practices and SEO, an LCP below 2.5 seconds and CLS below 0.1. The measured local mobile Performance score is 99.
